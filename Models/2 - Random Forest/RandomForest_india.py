...
x_train_ = pd.read_csv("train_india_x.csv", delimiter = ',', header = None)
x_test_ = pd.read_csv("test_india_x.csv", delimiter = ',', header = None)
y_train_ = pd.read_csv("train_india_y.csv", delimiter = ',', header = None)
y_test_ = pd.read_csv("test_india_y.csv", delimiter = ',', header = None)
